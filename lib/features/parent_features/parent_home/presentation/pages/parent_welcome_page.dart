...
class ParentWelcomePage extends StatelessWidget {
  ...
  final images = [
    AppIcons.circleUserIcon,
    AppIcons.visitingIcon,
    AppIcons.viewFileIcon,
                      ...
                      child: Row(
                        ...
                        children: [
                          CustomContainer(
                            ...
                            onTap: () {
                              Navigator.pushNamed(
                                  context, Routes.parentReportsPageRoute);
                            },
                          ),
                          ...
                          CustomContainer(
                            ...
                            onTap: () {
                              Navigator.pushNamed(
                                  context, Routes.parentVisitingPageRoute);
                            },
                          ),
                        ],
                      ),
                      ...
                      child: Row(
                        ...
                        children: [
                          CustomContainer(
                            ...
                            onTap: () {
                              Navigator.pushNamed(
                                  context, Routes.parentFilesPageRoute);
                            },
                          ),
                          const SizedBox(width: 30),
                          CustomContainer(
                            text: text[3],
                            image: AppIcons.smallIncubatorIcon,
                            color: AppColors.primaryColor.withOpacity(0.5),
                            onTap: () {
                              // Navigator.pushNamed(
                              //     context, Routes.parentVisitingPageRoute);
